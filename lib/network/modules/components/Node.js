...
class Node {
  ...
  constructor(
    ...
    this.labelOfNode = undefined; // for labelNodes, store the association of the node it is the label of
  ...
  setOptions(options) {
    ...
    if (options.labelOfNode !== undefined) {
      this.labelOfNode = options.labelOfNode;
    }
