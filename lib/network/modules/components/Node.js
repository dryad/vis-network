...
class Node {
  ...
  constructor(
    ...
    // labelNodes
    this.isLabelNode = undefined; //boolean to decide to handle this node as a labelNode
    this.labelNode = undefined; // for non-labelNodes to store their association to a labelNode
  ...
  setOptions(options) {
    ...
    if (options.isLabelNode !== undefined) {
      this.isLabelNode = options.isLabelNode;
    }
    if (options.labelNode !== undefined) {
  ...
  updateLabelModule(options) {
    ...
    // if (
    //   this.options.isLabelNode === undefined ||
    //   this.options.isLabelNode === null
    // ) {
    //   this.options.isLabelNode = false;
    // }
