  ...
  draw(ctx, x, y, selected, hover, values) {
    ...
    if (this.body.nodes[this.options.labelOfNode].selected) {
      if (this.options.label == undefined || this.options.label == "") {
        ...
        //uncomment these two lines to enable a rectangle border around unlabelled labelNodes (when selected)
        //also uncomment the drawRoundRect include at the top of the file.
